            ...
            >
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  >
                    {isSelected && <div className="w-2 h-2 bg-primary" />}
                  </div>
                  <div className="min-w-0">
...
function PaymentStep({ app, txid, priceUsd, priceFlux, period, onClose }) {
  ...
  if (confirmed) {
    return (
      <div className="flex flex-col items-center gap-4 py-8 text-center">
        <div className="w-14 h-14 bg-green-500/15 flex items-center justify-center">
  ...
  if (polling || pollError) {
    return (
      <div className="flex flex-col gap-5">
        ...
        <div className=" border border-border/40 bg-background/40 p-5 flex flex-col items-center gap-4 text-center">
          {polling ? (
            <>
        ...
        {polling && (
          <button type="button" onClick={onClose} className="text-sm text-text-muted hover:text-text text-center">
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <button type="button" onClick={onClose} className="text-sm text-text-muted hover:text-text mt-1">
        ← Back to billing
      </button>
    </div>
  );
...
export default function RenewModal({ app, currentBlock, onClose }) {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="relative w-full max-w-lg bg-surface border border-border/50 shadow-2xl p-6">
        {/* Close */}
        <button type="button" onClick={onClose} className="absolute top-4 right-4 p-1.5 text-text-muted hover:text-text hover:bg-surface-hover ">
          <X className="w-4 h-4" />
        </button>
        ...
        {phase === 'maxed' && (
          <div className="flex flex-col items-center gap-4 py-8 text-center">
            <div className="w-12 h-12 bg-amber-500/15 flex items-center justify-center">
        ...
        {phase === 'error' && (
          <div className="flex flex-col items-center gap-4 py-8 text-center">
            <div className="w-12 h-12 bg-red-500/15 flex items-center justify-center">
