...
function PlanCard({ plan, selected, disabled = false, disabledReason = '', onSelect }) {
  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center justify-center gap-1.5 px-3 py-1 border border-border rounded-full text-[11px] font-semibold uppercase tracking-wide w-fit mx-auto ${
