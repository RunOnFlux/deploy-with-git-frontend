...
function EnvValuePreview({ envKey, value, placeholder, revealed, copied, info, onToggleReveal, onCopy }) {
  ...
  return (
    <div className="flex items-start gap-2">
      ...
      <button
        type="button"
        className="shrink-0 p-1.5 rounded-md text-text-muted hover:text-text hover:bg-surface-hover"
        title={info}
...
export default function DatabaseAddon({ plan, config, appName, appPorts, onChange, onPlanChange }) {
  ...
  return (
    <div className="mb-5 rounded-xl border border-border bg-surface/40 p-4">
      ...
      {clusterAddonEnabled && (
        <div className="flex items-start gap-2 text-xs text-amber-300/80 bg-amber-400/5 border border-amber-400/15 rounded-lg px-3 py-2 mb-4 light:text-amber-700 env-warning">
