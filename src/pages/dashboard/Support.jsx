...
export default function Support() {
  ...
  const inputBase = 'w-full pl-10 pr-4 py-2.5 rounded-lg bg-background border text-sm text-text placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-primary/40 transition-colors';
  const inputClass = (f) =>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="card p-6">
              ...
              {/* Success */}
              {submitted && (
                <div className="flex items-start gap-3 p-4 mb-5 rounded-xl bg-green-500/10 border border-green-500/30 text-green-300">
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  <button
                    ...
                    className="relative w-full flex items-center justify-between pl-10 pr-4 py-2.5 rounded-lg bg-background border border-border/40 hover:border-border/60 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/40 transition-colors cursor-pointer"
                  >
